			...
			<main role="main" className="flex-shrink-0 mt-5"> {/*flex-shrink, especifica el factor de contracción de un flex item.*/}
		        ...
		        <div className="container" style={{padding: '0 60px 0 60px',}}> {/*Se da un estilo de padding para volver el espacio de horizontal un poco mas pequeño*/}
					...
					<div className= "row"> {/*se crea segunda clase hija de container*/}
						<div className="col-lg-6 contenedor-texto-home fuente"> {/*Se crea la primera columna que va a contener texto de home, las dos ultimas funciones se llaman de styleParrWe*/}
							...
							<p><a className="btn btn-primary btn-lg" href="https://www.miyuki-beads.co.jp/" target="_blank" role="button">Más información</a></p> {/*Se crea un link, para abrir otra url si desea mas informacion acerca del tema*/}
						</div>
